...
\newpage
\section{Final User Install Instructions}
...
\begin{enumerate}
    \item Download and install \href{https://www.enterprisedb.com/downloads/postgres-postgresql-downloads}{PostgreSQL}. \textbf{Remember to write down/remember your password, you will need it later.}
...
\begin{figure}[!htpb]
    \centering
    \includegraphics[height=73mm]{ITD/postgresql_install.png}
    \caption{You should have the above configuration at the end.}
\end{figure}
