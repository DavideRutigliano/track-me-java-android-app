...
\usepackage{hyphenat} %stops word separation on new line
\usepackage{fancyhdr}
\usepackage{enumitem}
\usepackage{listings}
\usepackage{xcolor}
...
\section{Introduction}
    ...
    \subsection{Definition, Acronyms and  Abbreviations}
            ...
            \begin{acronym}
                ...
                \acro{IU}{Individual User}
                \acro{TPU}{Third Party User}
            \end{acronym}
...
\section{Specific Requirements}
    ...
    \subsection{Functional Requirements}
        ...
        \bflow{The individual presses a register button.}
        ...
        \bflow{The third party presses a register button.}
              {TrackMe asks if user is an Individual or a Third Party. The user can choose between these two options.}
        ...
        \actor{Individual, TrackMe.}
        \pre{The individual has a username and a password and it's on the main page.}
        \bflow{The individual presses a login button.}
        ...
        \post{The individual is successfully granted privilege to access TrackMe and it's recognized as IU.}
        \end{usecase}
        ...
        \actor{Third Party, TrackMe.}
        \pre{The third party has a username and a password and it's on the main page.}
        \bflow{The third party presses a login button.}
              {TrackMe provides two boxes where the user can write. Former is titled 'username' while latter is called 'password'.}
              {The third party writes his username on the 'username' box and his associated password on 'password' box.}
              {TrackMe checks if that username is on the User DB and its associated password.}
              {TrackMe finds that username and its associated password are valid and grants access to the user.}
        \post{The third party is successfully granted privilege to access TrackMe and it's recognized as TPU.}
        \end{usecase}
...
\lstinputlisting[language=Alloy, caption=Model Definition, firstline=0, lastline=60]{TrackMeAlloyModel.als}
\begin{lstlisting}
\end{lstlisting}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
