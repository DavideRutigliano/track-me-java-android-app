...
\subsection{Functional Requirements}
    ...
    \goal{The Spectator should be able to watch a run.}
        ...
        \bflow{The system asks to provide username, password, SSN or FC based on region and user personal information such as name, surname, age, gender, e-mail, nationality and optional notes about his health condition.}
