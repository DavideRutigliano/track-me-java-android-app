...
\section{Introduction}
    ...
    \subsection{Scope and Audience}
        ...
        \begin{description}
            ...
            \item[GOAL-23] The Third Party should be able to view Individual's data to whom has sent a request.
        \end{description}
        ...
        \begin{description}
        	\item[GOAL-23] The Third Party should be able to view Individual's data to whom has sent a request. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
                	\item[REQ-27] Data4help must allow the Third Party to see a list of sent requests and related Individual's data.
                	\end{description}
                	\item
                	\begin{description}
                	\item[A-06] The user is logged in the system.
