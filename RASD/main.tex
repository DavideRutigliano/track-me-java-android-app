...
\section{Specific Requirements}
    ...
    \subsection{Functional Requirements}
        ...
        \name{Individual Subscribes to Automated-SOS}
        \brief{An individual wants to enable Automated-SOS, a service that guarantees that an ambulance will be called        in 5 seconds if the individual's health parameters are below certain thresholds.}
        \actor{Individual, Automated-SOS.}
        \pre{The individual is logged-in, it's on the main page and he's not subscribed to Automated-SOS.}
        \bflow{The individual presses the \textit{'Automated-SOS'} button.}
        ...
        \post{Individual is subscribed to Automated-SOS.}
        \end{usecase}
