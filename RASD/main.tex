...
\section{Specific Requirements}
    ...
    \subsection{Functional Requirements}
        ...
        \brief{An individual can enroll to a run created by an Organizer, using the Track4Run section of TrackMe.}
        \actor{Individual, Track4Run.}
        \pre{The individual is logged-in and it's on the main page, there is at least a run available.}
        ...
        % TODO: look again at these use case and decide what to implement
        ...
        \bflow{The user presses the \textit{'select run to watch'} button.}
              ...
              {The user press the \texit{'select'} button }
