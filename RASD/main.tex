...
\section{Introduction}
    ...
    \subsection{Scope and Audience}
        ...
        \comment{fix the undefull hbox error}\newline
        \newgoal{Allow a Guest to register as an Individual.}
        \newgoal{Allow a Guest to register as an Third-Party.}
        \newgoal{The Guest should be able to sign in into the application.}
        \newgoal{The User should be able to change his username.}
        \newgoal{The User should be able to change his password.}
...
\subsection{Functional Requirements}
        ...
        \goal{Allow a Guest to register as an Third-Party.}
        ...
        \goal{The User should be able to change his username.}
        ...
        \goal{The User should be able to change his password.}
        ...
        \newrequirement{The system must provide the possibility to change Third Party's organization data.}
        \assumption{Data provided by the Third-Party (i.e: VAT number) are valid.}
        \assumption{The user is logged in the system.}
      ...
      \end{usecase}
       ...
       \end{usecase}
        ...
        \brief{A third party subscribes to the data of individuals or groups who received at least a request.}
        \actor{Third Party.}
        ...
        \post{The third party is subscribed to the individuals' or group's data and will receive new data as soon as they are produced.}
        \end{usecase}
