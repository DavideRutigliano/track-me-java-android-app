...
\subsection{Predicates}
    ...
    \lstinputlisting[language=Alloy, caption=Common predicates, firstline=241, lastline=284]{TrackMeAlloyModel.als}
    
    \newpage
\subsection{Worlds}
    \lstinputlisting[language=Alloy, caption=Run data4Help, firstline=285, lastline=285]{TrackMeAlloyModel.als}
