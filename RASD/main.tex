...
\section{Specific Requirements}
    ...
    \subsection{Functional Requirements}
        ...
        \post{The individual is successfully granted privilege to access TrackMe and it's recognized as \textit{Individual User}.}
        \end{usecase}
        ...
        \bflow{The third party presses a login button.}
              ...
              {TrackMe checks if that username is on the User DB and its associated password.}
              {TrackMe finds that username and its associated password are valid and grants access to the user.}
        \post{The third party is successfully granted privilege to access TrackMe and it's recognized as \textit{Third-Party User}.}
        \end{usecase}
