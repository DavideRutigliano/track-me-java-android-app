...
\section{Specific Requirements}
    ...
    \subsection{Functional Requirements}
        ...
        \begin{figure}[!htpb]
    	\centering
    	\includegraphics[width=\textwidth]{images/UML/UseCasesDiagram.jpg}
        \end{figure}
        \newpage
    ...
    \subsection{Software System Attributes}
        ...
        The system is backed up 2 times a  week. in order to guarantee the database integrity and consistency. To avoid loss of data  the database is saved in 3 copy and the power supply is provided by a particular system that keeps online at least one database. Beside an UPS is present. 
