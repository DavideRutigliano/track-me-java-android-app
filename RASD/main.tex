...
\section{Specific Requirements}
 ...
 \begin{itemize}
            	    \item[\requirement]
                	\begin{description}
                	\item[REQ-1] A customer not signed-on must be able to begin the individual's registration process to \textit{TrackMe} providing a username, a password and his personal data.
                	\end{description}
                	\item
                	\begin{description}
        ...
        \begin{description}
        	\item[GOAL-02] Allow a guest to register as an Third-Party.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
                	\item[REQ-2]  A customer not signed-on must be able to begin the individual's registration process to \textit{TrackMe} providing a username, a password and its organization data.
                	\end{description}
                	\item
                	\begin{description}
                	\item[C-1] Username must be unique
        ...
        \begin{description}
        	\item[GOAL-03] The guest should be able to sign in into the application.
            	\begin{itemize}
                	...
                	\item
                	\begin{description}
                	\item[A-5] The user is already registered.
                	\end{description}
                	\item
                	\begin{description}
                	\item[A-6] Username and password provided shall match the ones previously stored in the registration process.
                	\end{description}
                	\end{itemize}
        \end{description}
        ...
        \begin{description}
        	\item[GOAL-04] The user should be able to change his username.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
                	\item[REQ-4] TrackMe must provide to users the possibility to change their username. 
                	\end{description}
                	\item
                	\begin{description}
       ...
       \end{usecase}
        	...
        	\item[GOAL-05] The user should be able to change his password.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
                	\item[REQ-5] TrackMe must provide to registered users the possibility to change their password. 
                	\end{description}
                	\item
                	\begin{description}
                	\item[A-7] The user is be logged in the system.
                	\end{description}
                		\item
                	\begin{description}
                	\item[A-1] Password should be at least 8 alphanumerical
       ...
       \begin{description}
        	\item[GOAL-08] The Third-Party should be able to change his organization data. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
                	\item[REQ-8] The system must provide the possibility to change Third Party's organization data. 
                	\end{description}
                	\item
                	\begin{description}
                	\item[A-7] The user is logged in the system.
                	...
                	\item
                	\begin{description}
                	\item[A-4] Data  provided  by  the  Third-Party  (i.e:  VAT  number)  is valid.
                	\end{description}
                	\end{itemize}
        \end{description}
        ...
        \subsubsection{Data4Help}
        	...
        	\item[GOAL-09] The Third-Party should be able to send requests to the individuals. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
                	\item[REQ-9] Data4help must allow the Third-Parties to send a request to a particular individual, provided his SSN/FC. 
                	\end{description}
                	\item
                	\begin{description}
                	\item[A-7] The user is logged in the system
                	...
                	\item
                	\begin{description}
                	\item[A-8] The Third-Party provides a SSN/FC of an user already registered into the system.
                	\end{description}
                	\end{itemize}
        \end{description}
 ...
 \begin{description}
        	\item[GOAL-13] The Individual shall be able connect an external device to the system.
            	\begin{itemize}
                	...
                	\item
                	\begin{description}
                	\item[A-11] The device provided by the user is compatible with the system.
                	\end{description}
                	\item
                	\begin{description}
                	\item[A-12] The user has activated NFC or Bluetooth on the mobile device.
                	\end{description}
                	\item
                	\begin{description}
                	\item[A-13] The user has activated NFC/Bluetooth on the external device.
                	\end{description}
                	\end{itemize}
        \end{description}.
         ...
         \begin{description}
        	\item[GOAL-17] The Organizer shall be able to create a run.
            	\begin{itemize}
                	...
                	\item
                	\begin{description}
                	\item[A-17] The organizer provides a not empty path.
                	\end{description}
        ...
        \begin{description}
        	\item[GOAL-18] The Organizer should be able to start a run.
            	\begin{itemize}
                	...
                	\item
                	\begin{description}
                	\item[A-18] The Organizer has already created a run.  
                	\end{description}
                	item
                	\begin{description}
                	\item[A-19] At least two athletes are enrolled in the run.
                	\end{description}
                	\end{itemize}
        \end{description}
        ...
        \begin{description}
        	\item[GOAL-19] The Organizer should be able to delete a run.
            	\begin{itemize}
                	...
                	\item
                	\begin{description}
                	\item[C-??] The run must have not been started.
                	\end{description}
                	\end{itemize}
        \end{description}
       ...
       \begin{description}
        	\item[GOAL-20] The Athlete should be able to enroll a run.
            	\begin{itemize}
                	...
                	\item
                	\begin{description}
                	\item[A-??] There is at least one created run.
                	\end{description}
                	\end{itemize}
        \end{description}
        ...
        \begin{description}
        	\item[GOAL-21] The Athlete should be able to unroll a run.
            	\begin{itemize}
                	...
                	\item
                	\begin{description}
                	\item[A-18] The Athlete should be enrolled to the run  
                	\end{description}
                	\end{itemize}
        \end{description}
