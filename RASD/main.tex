...
\section{Introduction}
    ...
    \subsection{Definition, Acronyms and  Abbreviations}
            ...
            \begin{acronym}
                ...
                \acro{HTTP}{Hyper Text Transfer Protocol over SSL}
...
\section{Specific Requirements}
    ...
    \subsection{Functional Requirements}
      ...
      \end{usecase}
        ...
        \begin{description}
        	\item[G-04] The user should be able to change his username using the application. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
       ...
       \end{usecase}
               ...
               \begin{description}
        	\item[G-05] The user should be able to change his password using the application. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
       ...
       \end{usecase}
        ...
        \begin{description}
        	\item[G-06] The user should be able to log-out from the system. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
       ...
       \begin{description}
        	\item[G-07] The individual should be able to change his personal data. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
       ...
       \begin{description}
        	\item[G-08] The Third-Party should be able to change his personal data. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
       ...
       \end{usecase}
        ...
        \subsubsection{Data4Help}
            ...
            \begin{description}
        	\item[G-09] The Third-Party should be able to send requests to the individuals. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \except{If the Individual associated with the SSN/FC given is not registered an error message is printed}
        \epoint{The Third-Party selects the 'Subscribe to new data' option}
        \end{usecase}
        
        \begin{description}
        	\item[G-10] The Third-Party should be able to make group requests. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \end{usecase}
                ...
                \begin{description}
        	\item[G-11] The Third-Party should be able to subscribe to new data, once an Individual request is made. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \begin{description}
        	\item[G-12] The Individual should be able to accept or reject a request coming from a Third-Party. 
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
 ...
 \begin{description}
        	\item[G-13] The Individual shall be able connect an external device to the system.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \subsubsection{Automated-SOS }
         ...
         \begin{description}
        	\item[G-14] The Third-Party shall be able to activate Automated-SOS service.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \end{usecase}
           ...
           \begin{description}
        	\item[G-15] The Individual shall be able to activate Automated-SOS service.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \end{usecase}
         ...
         \begin{description}
        	\item[G-16] The Dispatcher shall be able to assign an ambulance to an incident.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \subsubsection{Track4Run}
         ...
         \begin{description}
        	\item[G-17] The Organizer shall be able to create a run.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \begin{description}
        	\item[G-18] The Organizer should be able to start a run.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \begin{description}
        	\item[G-19] The Organizer should be able to delete a run.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
       ...
       \begin{description}
        	\item[G-20] The Athlete should be able to enroll a run.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
        ...
        \begin{description}
        	\item[G-20] The Athlete should be able to enroll a run.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
                	\item[REQ-26] Track4Run must allow the Athlete to enroll a run.
                	\end{description}
                	\item
                	\begin{description}
                	\item[A-7] The user shall be logged in the system         \end{description}
        ...
        \begin{description}
        	\item[G-20] The Spectator/Organizer shall be able to watch a run.
            	\begin{itemize}
            	    \item[\requirement]
                	\begin{description}
    ...
    \subsection{Software System Attributes}
        ...
        The system can work both on smart phone and desktop environment. Any personal computer with Java SDK installed can execute TrackMe. Different version of Android and iOS can should support the mobile application.
