...
public class RunControllerTest {
    ...
    public void enrollRunTest() {
        ...
        String result = runController.enrollRun("0");


        Assert.assertEquals(Message.RUN_ENROLLED.toString(), result);
    ...
    public void unenrolledRunTest() {
        ...
        String result = runController.unenrollRun("0");


        Assert.assertEquals(Message.RUN_UNENROLLED.toString(), result);
